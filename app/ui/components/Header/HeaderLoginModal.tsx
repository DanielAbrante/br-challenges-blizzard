    ...
    <dialog className="bg-modalBackground py-16 px-32" ref={ref}>
      ...
      <div className="flex flex-col items-center">
        ...
        <form className="my-10">
          <h2>
            <p>
              <input type="text" name="email" id="email" placeholder="E-mail ou telefone" className="w-[26.625rem] px-4 py-3 rounded placeholder:text-grayBold placeholder:font-thin" />
            </p>

            <p>
              <input type="password" name="password" id="password" placeholder="Senha" className="w-[26.625rem] px-4 py-3 rounded placeholder:text-grayBold placeholder:font-thin mt-4" />
            </p>

            <button className="mt-6 bg-blue text-white w-full py-3 font-semibold rounded">Conectar-se</button>
          </h2>
        </form>
        ...
        <div className="text-white flex flex-col items-center">
          ...
          <ul className="flex gap-4 mt-4">
            <li className="bg-white p-3 hover:cursor-pointer hover:opacity-90"><Image src={googleIcon} alt="" /></li>
            <li className="bg-white p-3 hover:cursor-pointer hover:opacity-90"><Image src={appleIcon} alt="" /></li>
            <li className="bg-white p-3 hover:cursor-pointer hover:opacity-90"><Image src={facebookIcon} alt="" /></li>
          </ul>
