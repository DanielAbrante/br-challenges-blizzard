            ...
            <div className="relative flex justify-center items-center h-[158px] w-full">
                {
                    !isPlayingTrailer ?
                        <>
                            <Image src={banners[bannerIndex].gameLogoTrailer} alt={""} fill className="hidden tablet:block object-cover" onMouseEnter={playTrailer} />
                            <Image src={playIcon} alt="" className="absolute" />
                        </> :
                        <Image src={banners[bannerIndex].gameTrailer} alt={""} unoptimized fill className="hidden tablet:block object-cover" onMouseLeave={stopTrailer} />
                }
