...
export const MenuDrop = () => {
	...
	return (
		<section className="absolute top-0 left-0 z-40 flex w-full justify-center bg-gradient-to-b from-black400 to-black pt-36 backdrop-blur-sm">
			<div className="w-full">
				...
				<footer className="w-full bg-black500 py-6">
